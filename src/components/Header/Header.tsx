          ...
          {isAuthenticated && (
            ...
            >
              <div className='mr-2 h-6 w-6 shrink-0'>
                <img
                  src='https://lh3.googleusercontent.com/-g4igvrZGS4g/AAAAAAAAAAI/AAAAAAAAAAA/AN6ncHhtaco7slbz1ZST7kO4R_oAN8mhrw/photo.jpg'
                  alt='avatar'
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/baf31820f5be7e6c413cd3ff3819fe80_tn'
                            alt='product'
                        ...
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>
                            Pack 3 đôi tất thể thao Nike DRI FIT cao cổ màu trắng Đá bóng Chạy bộ tập Gym - Free ship
                            TatsTats.vn
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>₫120.000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
